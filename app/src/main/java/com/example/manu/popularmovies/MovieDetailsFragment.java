...
import com.example.manu.popularmovies.adapters.ReviewAdapter;
import com.example.manu.popularmovies.adapters.TrailerAdapter;
import com.example.manu.popularmovies.data.MovieContract;
import com.example.manu.popularmovies.model.Movie;
import com.example.manu.popularmovies.model.Trailer;
import com.example.manu.popularmovies.model.Review;
...
public class MovieDetailsFragment extends Fragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        if (mMovie != null) {
            inflater.inflate(R.menu.menu_fragment_movie_details, menu);
            ...
            new AsyncTask<Void, Void, Integer>() {
                ...
                protected Integer doInBackground(Void... params) {
                    return FavoritedUtility.isFavorited(getActivity(), mMovie.getId());
                }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mMovie != null) {
            ...
            String image_url = FavoritedUtility.buildImageUrl(342, mMovie.getImage2());
