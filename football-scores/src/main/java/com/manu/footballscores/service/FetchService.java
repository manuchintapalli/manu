package com.manu.footballscores.service;
...
import com.manu.footballscores.BuildConfig;
import com.manu.footballscores.network.FootballApi;
import com.manu.footballscores.network.model.Fixture;
import com.manu.footballscores.network.model.FixturesResponse;
import com.manu.footballscores.network.model.HrefWrapper;
import com.manu.footballscores.network.model.Season;
import com.manu.footballscores.network.model.Team;
...
public final class FetchService extends IntentService {
    ...
    public static final String BROADCAST_DATA_UPDATED = "com.manu.footballscores.BROADCAST_DATA_UPDATED";
        ...
        final RestAdapter restAdapter = new RestAdapter.Builder()
                ...
                .setRequestInterceptor(new RequestInterceptor() {
                    @Override public void intercept(RequestFacade request) {
                        // please enter the API key in BuildConfig, Gradle.properties files
